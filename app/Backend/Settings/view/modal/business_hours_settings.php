    ...
    <div class="settings-light-portlet">
        ...
        <div class="businness-hours-alert p-3">
            ...
            <p class="businness-hours-alert__content">
                <?php echo bkntc__("Additional customization available for services and staff under the 
                'Time Sheet' tab. Remember, Staff Schedules take precedence over Service Schedules, which, in turn, override general business hours.")?>
            </p>
        </div>
