(function ($)
{
	...
	$(document).ready(function()
	{
		...
		} ).on( 'click', '.booknetic_leave_beta_modal_top_right, .booknetic_leave_beta_modal_bottom_right > .booknetic_cancel', function () {
...
var booknetic =
{
    ...
    confirmV2: function(contentText, confirmButtonText, cancelButtonText, confirmHeaderText, successCallback, cancelCallback, shouldCloseModal) {
		...
		const modal = booknetic.modal(modalContainer, { type : 'center', 'z_index' : 99999999999999});
