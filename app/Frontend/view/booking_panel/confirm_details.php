            ...
            <div class="booknetic_payment_methods_footer">
                <?php if ( ! Helper::isSaaSVersion() || ! Capabilities::tenantCan( 'disable_deposit_payments' ) ): ?>
                    <?php if ( $parameters[ 'has_deposit' ] ): ?>
                        ...
                        <?php if ( Helper::getOption( 'deposit_can_pay_full_amount', 'on' ) == 'on' ): ?>
                            <div class="booknetic_deposit_radios booknetic_hide_on_local <?php echo $first_is_local_method ? 'booknetic_hidden' : ''; ?>">
                                <div><input type="radio" id="input_deposit_2" name="input_deposit" value="1"
                                            checked><label
                                            for="input_deposit_2"><?php echo bkntc__( 'Deposit' ) ?></label></div>
                                <div><input type="radio" id="input_deposit_1" name="input_deposit" value="0"><label
                                            for="input_deposit_1"><?php echo bkntc__( 'Full amount' ) ?></label>
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
