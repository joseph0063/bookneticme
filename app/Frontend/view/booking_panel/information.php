...
<div class="form-row">
	<div class="form-group col-md-6">
        ...
        <input type="text" id="bkntc_input_email" class="form-control" name="email" value="<?php echo htmlspecialchars($parameters['email'])?>" <?php echo (!empty($parameters['email']) && $parameters['email_disabled']) && !(Permission::isStaff() || Permission::isAdministrator()) ? "disabled" : "" ?>>
    </div>
    <div class="form-group col-md-6">
        <div class="bkntc_label-container">
        ...
        <div  class="bkntc_input_phone-container">
            <input type="tel" id="bkntc_input_phone" class="form-control" name="phone" value="<?php echo htmlspecialchars($parameters['phone'])?>" data-country-code="<?php echo Helper::getOption('default_phone_country_code', '')?>">
        </div>
	</div>
</div>
