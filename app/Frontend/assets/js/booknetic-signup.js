(function($)
{
    ...
    function __( key )
    {
        return key in BookneticDataSP.localization ? BookneticDataSP.localization[ key ] : key;
    }
    ...
    let booknetic = {
        ...
        toast: function(title , type , duration )
        {
            ...
            $("#booknetic-toastr .booknetic-toast-img > img").attr('src', BookneticDataSP.assets_url + 'icons/' + type + '.svg');
    ...
    let google_recaptcha_action = 'customer_signup';
    ...
    $(document).ready( function()
    {
        ...
        $(document).on('click', '.booknetic_signup_btn', function ()
        {
            let form        = $(this).closest('.booknetic_signup'),
                first_name	= form.find('#booknetic_first_name').val(),
                last_name	= form.find('#booknetic_last_name').val(),
                email		= form.find('#booknetic_email').val(),
                password	= form.find('#booknetic_password').val();

            booknetic.ajax('signup', {
        ...
        }).on('click', '.booknetic_resend_activation_link', function ()
        {
            ...
            booknetic.ajax('resend_activation_link', { email: email, password: password }, function ( result )
            {
                form.find('.booknetic_resend_activation').hide();
        ...
        {
            $(this).find('.booknetic_signup_btn').click();
            return false;
        });
