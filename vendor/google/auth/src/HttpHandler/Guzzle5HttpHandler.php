 ...
 */
namespace BookneticVendor\Google\Auth\HttpHandler;

use Exception;
use BookneticVendor\GuzzleHttp\ClientInterface;
use BookneticVendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use BookneticVendor\GuzzleHttp\Promise\Promise;
use BookneticVendor\GuzzleHttp\Promise\RejectedPromise;
use BookneticVendor\GuzzleHttp\Psr7\Response;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('BookneticVendor\\GuzzleHttp\\Promise\\Promise')) {
