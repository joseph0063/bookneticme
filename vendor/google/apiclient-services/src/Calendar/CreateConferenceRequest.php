...
class CreateConferenceRequest extends \BookneticVendor\Google\Model
{
...
\class_alias(CreateConferenceRequest::class, 'BookneticVendor\\Google_Service_Calendar_CreateConferenceRequest');
