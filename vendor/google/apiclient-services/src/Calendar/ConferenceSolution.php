...
class ConferenceSolution extends \BookneticVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConferenceSolution::class, 'BookneticVendor\\Google_Service_Calendar_ConferenceSolution');
