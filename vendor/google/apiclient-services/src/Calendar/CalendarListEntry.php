...
class CalendarListEntry extends \BookneticVendor\Google\Collection
{
...
\class_alias(CalendarListEntry::class, 'BookneticVendor\\Google_Service_Calendar_CalendarListEntry');
