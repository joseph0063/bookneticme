...
class FreeBusyRequest extends \BookneticVendor\Google\Collection
{
...
\class_alias(FreeBusyRequest::class, 'BookneticVendor\\Google_Service_Calendar_FreeBusyRequest');
