...
class FreeBusyResponse extends \BookneticVendor\Google\Model
{
...
\class_alias(FreeBusyResponse::class, 'BookneticVendor\\Google_Service_Calendar_FreeBusyResponse');
