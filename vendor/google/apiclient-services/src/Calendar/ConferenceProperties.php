...
class ConferenceProperties extends \BookneticVendor\Google\Collection
{
...
\class_alias(ConferenceProperties::class, 'BookneticVendor\\Google_Service_Calendar_ConferenceProperties');
