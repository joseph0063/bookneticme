...
use BookneticVendor\Google\Service\Oauth2\Tokeninfo;
/**
 ...
 * @author Google, Inc.
 */
class Oauth2 extends \BookneticVendor\Google\Service
{
...
\class_alias(Oauth2::class, 'BookneticVendor\\Google_Service_Oauth2');
