...
class ListForwardingAddressesResponse extends \BookneticVendor\Google\Collection
{
...
\class_alias(ListForwardingAddressesResponse::class, 'BookneticVendor\\Google_Service_Gmail_ListForwardingAddressesResponse');
