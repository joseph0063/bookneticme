 ...
 * the License.
 */
namespace BookneticVendor\Google\Service\Gmail\Resource;

use BookneticVendor\Google\Service\Gmail\AutoForwarding;
use BookneticVendor\Google\Service\Gmail\ImapSettings;
use BookneticVendor\Google\Service\Gmail\LanguageSettings;
use BookneticVendor\Google\Service\Gmail\PopSettings;
use BookneticVendor\Google\Service\Gmail\VacationSettings;
/**
 ...
 *  </code>
 */
class UsersSettings extends \BookneticVendor\Google\Service\Resource
{
    /**
...
\class_alias(UsersSettings::class, 'BookneticVendor\\Google_Service_Gmail_Resource_UsersSettings');
