...
use BookneticVendor\Google\Service\Gmail\BatchDeleteMessagesRequest;
use BookneticVendor\Google\Service\Gmail\BatchModifyMessagesRequest;
use BookneticVendor\Google\Service\Gmail\ListMessagesResponse;
use BookneticVendor\Google\Service\Gmail\Message;
use BookneticVendor\Google\Service\Gmail\ModifyMessageRequest;
/**
 ...
 *  </code>
 */
class UsersMessages extends \BookneticVendor\Google\Service\Resource
{
    /**
...
\class_alias(UsersMessages::class, 'BookneticVendor\\Google_Service_Gmail_Resource_UsersMessages');
