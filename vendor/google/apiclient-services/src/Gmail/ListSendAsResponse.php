...
class ListSendAsResponse extends \BookneticVendor\Google\Collection
{
...
\class_alias(ListSendAsResponse::class, 'BookneticVendor\\Google_Service_Gmail_ListSendAsResponse');
