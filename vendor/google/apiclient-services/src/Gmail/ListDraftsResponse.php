...
class ListDraftsResponse extends \BookneticVendor\Google\Collection
{
...
\class_alias(ListDraftsResponse::class, 'BookneticVendor\\Google_Service_Gmail_ListDraftsResponse');
