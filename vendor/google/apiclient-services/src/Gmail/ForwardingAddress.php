...
class ForwardingAddress extends \BookneticVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ForwardingAddress::class, 'BookneticVendor\\Google_Service_Gmail_ForwardingAddress');
