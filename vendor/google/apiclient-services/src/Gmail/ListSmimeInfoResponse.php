...
class ListSmimeInfoResponse extends \BookneticVendor\Google\Collection
{
...
\class_alias(ListSmimeInfoResponse::class, 'BookneticVendor\\Google_Service_Gmail_ListSmimeInfoResponse');
