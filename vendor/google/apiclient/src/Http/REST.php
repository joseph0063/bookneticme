 ...
 */
namespace BookneticVendor\Google\Http;

use BookneticVendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use BookneticVendor\Google\Client;
use BookneticVendor\Google\Task\Runner;
use BookneticVendor\Google\Service\Exception as GoogleServiceException;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if ($response instanceof \BookneticVendor\GuzzleHttp\Message\ResponseInterface) {
