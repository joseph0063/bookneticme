 ...
 */
namespace BookneticVendor\Google;

use BookneticVendor\Google\AccessToken\Revoke;
use BookneticVendor\Google\AccessToken\Verify;
use BookneticVendor\Google\Auth\ApplicationDefaultCredentials;
...
use BookneticVendor\Google\Auth\OAuth2;
use BookneticVendor\Google\Auth\Credentials\ServiceAccountCredentials;
use BookneticVendor\Google\Auth\Credentials\UserRefreshCredentials;
use BookneticVendor\Google\AuthHandler\AuthHandlerFactory;
use BookneticVendor\Google\Http\REST;
use BookneticVendor\GuzzleHttp\Client as GuzzleClient;
use BookneticVendor\GuzzleHttp\ClientInterface;
use BookneticVendor\GuzzleHttp\Ring\Client\StreamHandler;
use BookneticVendor\Psr\Cache\CacheItemPoolInterface;
use BookneticVendor\Psr\Http\Message\RequestInterface;
use BookneticVendor\Psr\Log\LoggerInterface;
use BookneticVendor\Monolog\Logger;
use BookneticVendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use BookneticVendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\BookneticVendor\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\BookneticVendor\\GuzzleHttp\\ClientInterface::VERSION')) {
