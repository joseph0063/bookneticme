...
use BookneticVendor\Aws\Sdk;
use BookneticVendor\Aws\DynamoDb\DynamoDbClient;
use BookneticVendor\Monolog\Formatter\FormatterInterface;
use BookneticVendor\Aws\DynamoDb\Marshaler;
use BookneticVendor\Monolog\Formatter\ScalarFormatter;
