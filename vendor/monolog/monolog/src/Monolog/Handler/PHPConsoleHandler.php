...
use BookneticVendor\Monolog\Formatter\LineFormatter;
use BookneticVendor\Monolog\Formatter\FormatterInterface;
use BookneticVendor\Monolog\Logger;
use BookneticVendor\Monolog\Utils;
use BookneticVendor\PhpConsole\Connector;
use BookneticVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use BookneticVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('BookneticVendor\\PhpConsole\\Connector')) {
