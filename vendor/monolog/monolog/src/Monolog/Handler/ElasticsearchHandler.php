...
use BookneticVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use BookneticVendor\Monolog\Logger;
use BookneticVendor\Monolog\Formatter\FormatterInterface;
use BookneticVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use BookneticVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use BookneticVendor\Elasticsearch\Client;
use BookneticVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use BookneticVendor\Elastic\Elasticsearch\Client as Client8;
/**
