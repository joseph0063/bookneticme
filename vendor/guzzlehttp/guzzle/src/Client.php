...
use BookneticVendor\GuzzleHttp\Cookie\CookieJar;
use BookneticVendor\GuzzleHttp\Exception\GuzzleException;
use BookneticVendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BookneticVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
