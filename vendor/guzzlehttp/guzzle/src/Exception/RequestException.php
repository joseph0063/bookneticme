...
namespace BookneticVendor\GuzzleHttp\Exception;

use BookneticVendor\GuzzleHttp\BodySummarizer;
use BookneticVendor\GuzzleHttp\BodySummarizerInterface;
use BookneticVendor\Psr\Http\Client\RequestExceptionInterface;
