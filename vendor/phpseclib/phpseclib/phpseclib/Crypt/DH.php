...
use BookneticVendor\phpseclib3\Crypt\DH\Parameters;
use BookneticVendor\phpseclib3\Crypt\DH\PrivateKey;
use BookneticVendor\phpseclib3\Crypt\DH\PublicKey;
use BookneticVendor\phpseclib3\Exception\NoKeyLoadedException;
