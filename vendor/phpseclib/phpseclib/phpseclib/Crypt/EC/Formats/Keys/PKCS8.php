 ...
 */
namespace BookneticVendor\phpseclib3\Crypt\EC\Formats\Keys;

use BookneticVendor\phpseclib3\Common\Functions\Strings;
use BookneticVendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use BookneticVendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use BookneticVendor\phpseclib3\File\ASN1\Maps;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('BookneticVendor\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
