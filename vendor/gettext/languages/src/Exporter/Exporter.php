...
namespace BookneticVendor\Gettext\Languages\Exporter;
...
abstract class Exporter
{
     ...
     * @return string[]
     */
    public static final function getExporters($onlyForPublicUse = \false)
    {
        ...
        if ($onlyForPublicUse) {
            ...
            foreach (self::$exporters as $handle => $class) {
                if (\call_user_func(self::getExporterClassName($handle) . '::isForPublicUse') === \true) {
                    $result[$handle] = $class;
                }
            }
        } else {
     ...
     * @return string
     */
    public static final function getExporterDescription($exporterHandle)
    {
     ...
     * @return string
     */
    public static final function getExporterClassName($exporterHandle)
    {
     ...
     * @return string
     */
    public static final function toString($languages, $options = null)
    {
     ...
     * @throws \Exception
     */
    public static final function toFile($languages, $filename, $options = null)
    {
