...
namespace BookneticVendor\Gettext\Utils;

use BookneticVendor\Gettext\Extractors\PhpCode;
class PhpFunctionsScanner extends FunctionsScanner
{
    ...
    {
        $this->tokens = \array_values(\array_filter(\token_get_all($code), function ($token) {
