...
class Jed extends Generator implements GeneratorInterface
{
    ...
    public static function toString(Translations $translations, array $options = [])
    {
        ...
        return \json_encode([$domain => ['' => ['domain' => $domain, 'lang' => $translations->getLanguage() ?: 'en', 'plural-forms' => $translations->getHeader('Plural-Forms') ?: 'nplurals=2; plural=(n != 1);']] + static::buildMessages($translations)], $options['json']);
    }
    /**
    ...
    protected static function buildMessages(Translations $translations)
    {
        ...
        foreach ($translations as $translation) {
            ...
            if ($translation->hasPluralTranslations(\true)) {
